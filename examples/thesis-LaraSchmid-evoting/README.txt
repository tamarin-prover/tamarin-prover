...
As the models of the phone-based authentication protocols from Section 5.3 [1] require different explanations, they are in a separate folder chapter5_HumanErrors/AuthenticationProtocols together with a README file explaining these protocols.
...
LIST OF FILES WITH DESCRIPTION IN chapter3_Alethea/
---------------------------------------------------
Protocol Model Files
---------------------
...
LIST OF FILES WITH DESCRIPTION IN chapter4_DisputeResolution/
--------------------------------------------------------------------------------
Protocol Model Files
---------------------
...
LIST OF FILES WITH DESCRIPTION IN chapter5_HumanErrors/
--------------------------------------------------------------------------
